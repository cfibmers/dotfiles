...
syn keyword xInstruction a aghi ah al alg algr alr ap ar contained
syn keyword xInstruction bal balr bas basm bassm bc bcr bctr bsm bxh bxle contained
syn keyword xInstruction c cds ch chi cl clc clcl cli clm clr cp cr cs cvb cvd contained
...
syn keyword xInstruction l la larl lcr ld ldebr ledbr lg lgf lgfr lghi lgr lh
syn keyword xInstruction llgc llgf llgt llgtr llilh lm lmg lnr lpr lr ltgr ltr contained
syn keyword xInstruction m mh mp mr mvc mvcin mvcl mvi mvn mvo mvz contained
syn keyword xInstruction n nc ng ni nr contained
syn keyword xInstruction o oc oi oill or contained
syn keyword xInstruction pack contained
syn keyword xInstruction s sh sl sla slda sldl slg slgr sll slr sp
syn keyword xInstruction sr sra srda srdl srl srst sllg srlg srp st stb stc ste contained
syn keyword xInstruction spm stcm std sth stg stm stmg svc contained
...
syn keyword xBranch b balr basr bct be ber bh bhr bl blr bm bmr bne bner bnh contained
...
syn keyword xBranch br brasl bre brh brl brne brnh brnl bro bru bz bzr j contained
